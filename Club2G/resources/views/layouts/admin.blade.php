...
Home</a></li>
 <li><a href="{{ route('admin.treasure.index') }}" class="nav-link text-white">- Admin - Búsquedas del tesoro</a></li>
 <li>
 <li><a href="{{ route('admin.ubication.index') }}" class="nav-link text-white">- Admin - Ubicaciones</a></li>
 <li>
